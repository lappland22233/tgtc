...
export type NonEntityTableDefinition = {
  table: string;
  columns: Array<{ name: string; type: string; nullable: boolean }>;
  primaryColumns: string[];
  foreignKeys: ExpectedSqliteForeignKey[];
  indexes: SqliteIndexShape[];
  createSql: string;
  indexSql: string[];
};
 ...
 */
export const NON_ENTITY_TABLE_DEFINITIONS: NonEntityTableDefinition[] = [
  {
    table: 'file_tags',
    columns: [
